...
export function initMixin (Vue: Class<Component>) {
  Vue.prototype._init = function (options?: Object) {
    ...
    if (options && options._isComponent) {
      ...
      vm.$options = mergeOptions(  //简单的理解为合并，为 options 增加属性
    ...
    //组件的挂载
    if (vm.$options.el) {
      vm.$mount(vm.$options.el)    //将组件 挂载 到 el 描述的元素上
      /**
       * $mount 会先调用 扩展的 那个 $mount 方法，生成render
